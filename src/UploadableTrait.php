...
trait UploadableTrait
{
				...
				* @param 	bool $nullColumn     If set table column as null
				* @throws Exception
				* @return null
				*/
				public function deleteFile(string $table_column = null, string $folder = null, bool $nullColumn = false)
				{
						try{
				...
				* @return null
				*/
				public function deleteAllFiles($nullColumn = false)
				{
						try{
				...
				*
				* @property bool $nullColumn if set table column as null
				* @property array $this->storage_config
				* @property array $this->attributes model attributes
				*/
				private function updateModel($nullColumn = false)
				{
						$this->attributes[$this->storage_config['table_column']] = $nullColumn ? null : $this->storage_config['file_name'];
